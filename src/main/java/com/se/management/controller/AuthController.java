...
import com.se.management.event.OnGenerateResetLinkEvent;
import com.se.management.event.OnRegenerateEmailVerificationEvent;
import com.se.management.event.OnUserAccountChangeEvent;
import com.se.management.event.OnUserRegistrationCompleteEvent;
...
import com.se.management.model.response.JwtAuthenticationResponse;
...
public class AuthController {
    ...
    @ApiOperation(value = "Receive the reset link request and publish event to send mail containing the password " +
            "reset link")
    public ResponseEntity resetLink(@ApiParam(value = "The PasswordResetLinkRequest payload")
    ...
    @ApiOperation(value = "Reset the password after verification and publish an event to send the acknowledgement " +
            "email")
    public ResponseEntity resetPassword(@ApiParam(value = "The PasswordResetRequest payload")
