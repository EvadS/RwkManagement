...
import com.se.management.model.audit.EntityAuditorAware;
import com.se.management.validation.annotation.NullOrNotBlank;
import lombok.Data;
...
@Data
@Entity(name = "USER")
public class User  extends EntityAuditorAware {
