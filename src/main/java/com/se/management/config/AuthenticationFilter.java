...
import com.se.management.domain.UserCredentials;
import com.se.management.exception.UnreadableCredentialsException;
...
//
//    /**
//     *  function that is called whenever the API gets a request to the login path
//     * @param request
//     * @param response
//     * @return
//     */
